...
(async function createOrder() {
  ...
  const orderNumberContainerEls=document.querySelectorAll(".order-number-container");
  orderNumberContainerEls.forEach(orderNumberContainerEl => {
    orderNumberContainerEl.addEventListener("click", function(e) {
      const orderDetailContainerEl=e.target.parentElement.querySelector(".order-detail-container");
...
memberInfoTabEl.addEventListener("click", function() {
    ...
    // memberInfoEl.classList.add("function-checked");
